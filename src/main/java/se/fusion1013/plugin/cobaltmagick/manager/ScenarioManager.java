...
import se.fusion1013.plugin.cobaltmagick.scenario.Scenario;
...
public class ScenarioManager extends Manager {
    ...
    public static ScenarioManager getInstance(){
        if (INSTANCE == null){
            INSTANCE = new ScenarioManager(CobaltMagick.getInstance());
        }
        return INSTANCE;
    }
    ...
    public ScenarioManager(CobaltMagick cobaltMagick) {
        super(cobaltMagick);
