...
public class SpellManager extends Manager {
    ...
    public static final Spell REPAIRED_SPELL = register(new StaticProjectileSpell.StaticProjectileSpellBuilder(823, "repaired_spell")
            .addManaDrain(50).addCastDelay(1.33).setLifetime(.001)
            .addDescription("It doesn't seem to do anything...?")
            .setCustomModel(800022)
            .setSpellTiers(10)
            .setSpellTierWeights(0)
            .addExecuteOnCast(new SoundSpellModule(Sound.BLOCK_BEACON_DEACTIVATE, SoundCategory.PLAYERS, false))
            .addParticle(new ParticleGroup.ParticleGroupBuilder()
