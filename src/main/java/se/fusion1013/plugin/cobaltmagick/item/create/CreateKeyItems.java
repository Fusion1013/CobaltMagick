...
public class CreateKeyItems {
    ...
    public static CustomItem GOLD_KEY = CustomItemManager.register(new CustomItem.CustomItemBuilder("gold_key", Material.EMERALD, 1)
            .setCustomName(HexUtils.colorify("&6Gold Key"))
            .setCustomModel(5000).setItemCategory(MagickItemCategory.KEY).build());

    public static CustomItem SHADOW_KEY = CustomItemManager.register(new CustomItem.CustomItemBuilder("shadow_key", Material.EMERALD, 1)
            .setCustomName(HexUtils.colorify("&5Shadow Key"))
            .setCustomModel(5001).setItemCategory(MagickItemCategory.KEY).build());

    // ----- BIOME KEYS -----

    public static CustomItem JUNGLE_KEY = CustomItemManager.register(new CustomItem.CustomItemBuilder("jungle_key", Material.EMERALD, 1)
    ...
    public static CustomItem CORRUPTION_KEY = CustomItemManager.register(new CustomItem.CustomItemBuilder("corruption_key", Material.EMERALD, 1)
    ...
    public static CustomItem CRIMSON_KEY = CustomItemManager.register(new CustomItem.CustomItemBuilder("crimson_key", Material.EMERALD, 1)
    ...
    public static CustomItem HALLOWED_KEY = CustomItemManager.register(new CustomItem.CustomItemBuilder("hallowed_key", Material.EMERALD, 1)
    ...
    public static CustomItem FROZEN_KEY = CustomItemManager.register(new CustomItem.CustomItemBuilder("frozen_key", Material.EMERALD, 1)
    ...
    public static CustomItem DESERT_KEY = CustomItemManager.register(new CustomItem.CustomItemBuilder("desert_key", Material.EMERALD, 1)
