...
public class WarpCommand {
    ...
    private static void warpTp(Player player, Object[] args){
        LocaleManager localeManager = CobaltMagick.getInstance().getManager(LocaleManager.class);
        UUID pID = player.getUniqueId();

        String name = (String)args[0];
        List<Warp> warps = CobaltMagick.getInstance().getRDatabase().getWarpsByName(name);
    ...
    private static void warpCreate(Player player, Object[] args){
        LocaleManager localeManager = CobaltMagick.getInstance().getManager(LocaleManager.class);
        List<Warp> currentWarps = CobaltMagick.getInstance().getRDatabase().getWarps();
        ...
        CobaltMagick.getInstance().getRDatabase().insertWarp(warp);
    ...
    private static void warpDelete(Player player, Object[] args){
        ...
        String name = (String)args[0];
        int deletedWarps = CobaltMagick.getInstance().getRDatabase().deleteWarp(name);
        StringPlaceholders namePlaceholder = StringPlaceholders.builder()
