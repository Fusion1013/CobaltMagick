package se.fusion1013.plugin.cobaltmagick.commands.cgive;
...
public class CGiveCommand {
     ...
     */
    private static int giveSpellOfType(Player player, SpellType type){
        ...
        ItemUtil.giveShulkerBox(player, itemStacks, Material.CYAN_SHULKER_BOX, type.getSpellColor() + "" + type);
    ...
    private static void giveAllSpells(Player player, Object[] args){
        ...
        if (args.length > 0){
            type = SpellType.valueOf(((String)args[0]).toUpperCase());
